"""
Django settings for Chattrr project.
...
WSGI_APPLICATION = 'Chattrr.wsgi.application'
...
if os.getenv('ACCESS_TOKEN_LIFETIME') != None and os.getenv('REFRESH_TOKEN_LIFETIME'):
    SIMPLE_JWT = {
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    Path(BASE_DIR, 'client/build/static'),
]
